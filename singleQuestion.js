                ...
                <div className="control-button-in-exam-portal">
                    <Button.Group>
                        {this.props.trainee.activeQuestionIndex===0?
                            null
                            :
                            <Button style={{backgroundColor: localStorage.getItem('prevButtonColor'),color:'#fff', borderColor: localStorage.getItem('prevButtonColor')}} onClick={this.previous}>
                                <Icon type="left" />
                                Previousss
                            </Button>
                        }
                        ...
                        {this.props.trainee.activeQuestionIndex===this.props.trainee.questions.length-1?
                            null
                            :
                            <Button style={{backgroundColor: localStorage.getItem('nextButtonColor'), color: '#fff', borderColor: localStorage.getItem('nextButtonColor')}} onClick={this.next}>
